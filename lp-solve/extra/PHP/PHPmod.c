...
static zend_class_entry *register_class_LPSolveException(zend_class_entry *class_entry_Exception)
{
    ...
    class_entry = zend_register_internal_class_ex(&ce, class_entry_Exception, NULL);
...
PHP_MINIT_FUNCTION(phplpsolve55)
{
    ...
    zend_ce_LPSolveException = register_class_LPSolveException(zend_exception_get_default());
